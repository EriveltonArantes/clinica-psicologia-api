...
|----------|---------|---------|
| `/api/psicologos` | GET / POST / PUT / DELETE | CRUD de Psicologo |
| `/api/pacientes` | GET / POST / PUT / DELETE | CRUD de Paciente |
| `/api/sessaos` | GET / POST / PUT / DELETE | CRUD de Sessao |
| `/api/evolucaos` | GET / POST / PUT / DELETE | CRUD de Evolucao |
